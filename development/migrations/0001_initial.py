# Generated by Django 4.2 on 2023-12-03 19:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buyer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='development.buyer')),
            ],
        ),
        migrations.CreateModel(
            name='DevFormat',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buyer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='development.buyer')),
                ('color_shade', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='development.devcolorshade')),
                ('format', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='development.devformat')),
            ],
        ),
        migrations.CreateModel(
            name='DevReport',
            fields=[
                ...
                ('buyer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='development.buyer')),
                ('color_shade', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='development.devcolorshade')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('format', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='development.devformat')),
            ],
        ),
    ]
